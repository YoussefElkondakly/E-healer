class RegisterV2DocModel {
  bool? status;
  String? errorNumber;
  String? message;
  User? user;

  RegisterV2DocModel({this.status, this.errorNumber, this.message, this.user});

  RegisterV2DocModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
